...
const PrivacyPolicy = () => (
  <div className="container mx-auto px-4 py-12 max-w-3xl text-gray-900">
    ...
    <h2 className="text-xl font-semibold mt-8 mb-2 text-maroon">2. Information We Collect</h2>
    <ul className="list-disc ml-6 mb-4">
      <li><span className="font-semibold">Personal Information:</span> Name, email address, phone number, address (if provided for service delivery), and any other information you voluntarily provide (e.g., through contact forms or bookings).</li>
    ...
    <ul className="list-disc ml-6 mb-4">
      ...
      <li>Send important updates or marketing communications (with your consent)</li>
      <li>Analyze website usage and trends</li>
      <li>Comply with legal obligations</li>
    </ul>

    <h2 className="text-xl font-semibold mt-8 mb-2 text-maroon">4. Legal Bases for Processing (GDPR)</h2>
