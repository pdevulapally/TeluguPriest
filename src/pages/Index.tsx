                 ...
                 <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8 border border-yellow-200">
                   ...
                   <div className="text-center mb-6 sm:mb-8">
                     ...
                     <div className="flex justify-center mb-4 sm:mb-6">
                       <div className="relative w-24 h-20 sm:w-32 sm:h-28 md:w-40 md:h-36">
                         <img 
                           src="/Images/satyanarayana-swamy-pooja-photo-738052.jpg" 
                           alt="Goddess Lakshmi" 
                    ...
                    🕉️ SATYANARAYANA VRATHAM -   Nov 15th @ 6:00 PM BST🕉️
                     </h2>
                     <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-4 sm:mb-6 text-center leading-relaxed px-2">
                       Join our special WhatsApp group for the SatyaNarayana Vratham ceremony. 
                   ...
                   <div className="bg-green-50 rounded-lg sm:rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                     ...
                     <p className="text-green-700 mb-4 sm:mb-6 text-center text-sm sm:text-base leading-relaxed">
                       Stay connected with Pandit Eswar Prasad and other devotees for the Satyanarayana Vratham ceremony.
                     </p>
                     <div className="flex justify-center">
                       <a
                         ...
                         className="inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 md:px-8 py-3 sm:py-4 bg-green-600 hover:bg-green-700 text-white font-semibold text-sm sm:text-base md:text-lg rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto max-w-xs sm:max-w-sm md:max-w-md whitespace-nowrap"
                       >
                         ...
                         <span className="text-center">Join Satyanarayana Vratham Group</span>
                       </a>
                     </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600">
                     <div className="flex items-center justify-center">
                       <span className="bg-yellow-100 text-yellow-800 px-3 sm:px-4 py-2 rounded-full text-center text-xs sm:text-sm">📅 November 15th, 2025</span>
                     </div>
                     <div className="flex items-center justify-center">
                       <span className="bg-blue-100 text-blue-800 px-3 sm:px-4 py-2 rounded-full text-center text-xs sm:text-sm">⏰ 6:00 PM UK Time</span>
                     </div>
                     <div className="flex items-center justify-center">
